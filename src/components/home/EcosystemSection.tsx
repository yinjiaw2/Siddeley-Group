...
export default function EcosystemSection() {
  ...
  const taglineHighlight = locale === "en" ? "Futures" : "明";
  const highlightIndex = mainTagline.indexOf(taglineHighlight);
          ...
          <div className="absolute left-1/2 top-[10%] z-30 w-[min(88%,760px)] -translate-x-1/2 text-center">
            ...
            >
              ...
              <span>
                {highlightIndex >= 0 ? (
                  <>
                    {mainTagline.slice(0, highlightIndex)}
                    <span className="text-black">{taglineHighlight}</span>
                    {mainTagline.slice(
                      highlightIndex + taglineHighlight.length,
                    )}
                  </>
                ) : (
                  mainTagline
