  ...
  return (
    <div className="w-full font-sans bg-[#F8FAFC]">
      {/* =========================================
          HERO SECTION 
          ========================================= */}
      {/* Background: Midnight Blue (#172554) */}
      <section className="relative flex min-h-[85vh] w-full flex-col items-center justify-center overflow-hidden bg-[#172554] px-6 py-24 text-center md:px-10 lg:px-16">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(148,163,184,0.15),transparent_50%)]" />
        ...
        <div className="relative z-10 max-w-4xl">
          ...
          {/* Text: Crisp Pearl (#F8FAFC) & Platinum (#94A3B8) */}
          <h1 className="text-5xl font-extrabold leading-tight tracking-tight text-[#F8FAFC] md:text-6xl lg:text-7xl">
            Cool, Sleek, <span className="text-[#94A3B8]">Modern</span>
          </h1>

          <p className="mx-auto mt-8 max-w-2xl text-lg text-[#94A3B8] md:text-xl leading-relaxed">
          ...
          <div className="mt-12 flex justify-center">
            {/* Button: Muted Teal (#0F766E) */}
            <Link
              href="#intro"
              className="inline-flex items-center gap-2 rounded-sm bg-[#0F766E] px-8 py-4 text-base font-semibold text-[#F8FAFC] transition-all hover:bg-[#0F766E]/80 hover:translate-y-[-2px] shadow-lg shadow-[#0F766E]/20"
            >
      ...
      <section id="intro" className="w-full bg-[#F8FAFC] py-24 md:py-32">
