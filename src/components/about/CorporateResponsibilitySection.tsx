      ...
      <div className="mx-auto max-w-7xl px-6 md:px-10 lg:px-16">
        ...
        <div className="mb-14 md:mb-16">
          ...
          <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
            ...
            <p className="font-app-body max-w-md text-[17px] leading-[1.9] text-[#5F5854] lg:text-right md:text-[18px]">
              {t("subtitle")}
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
          {pillars.map(({ Icon, label, title, desc }) => (
            ...
            >
              ...
              <div>
                <span className="font-app-body mb-2 block text-[11px] font-bold uppercase tracking-[0.30em] text-[#C79D00]">
                  {label}
                </span>
                <h3 className="font-app-heading text-[21px] font-extrabold leading-tight tracking-[-0.02em] text-[#1A1A1A] md:text-[23px]">
                  {title}
                </h3>
              </div>
              <p className="font-app-body text-[15px] leading-[1.9] text-[#6B6B6B]">
                {desc}
              </p>
            </article>
          ))}
