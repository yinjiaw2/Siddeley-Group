...
type Category = "all" | "board" | "executive" | "specialists" | "emerging";
    ...
    <section className="w-full bg-[#F8F5EF] py-20 md:py-28">
      <div className="mx-auto max-w-7xl px-6 md:px-10 lg:px-16">
        ...
        <div className="mb-12 md:mb-16">
          ...
          <p
            className="mt-6 max-w-2xl text-[17px] leading-[1.9] text-[#5F5854] md:text-[18px]"
            style={fontStyle}
          >
            {t("subtitle")}
          </p>
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {visible.map((member) => {
            const color = avatarColors[member.id] ?? "#C79D00";
